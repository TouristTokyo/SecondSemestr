...
public class GraphUtils {
    ...
    public static String graphToDot(MySimpleGraph graph) {
        StringBuilder builder = new StringBuilder();
        builder.append("graph G {\n");
        builder.append("node[style=\"filled\", fillcolor=\"blue\"];\n");
        ...
        builder.append("\n");
        builder.append("node[style=\"filled\", fillcolor=\"red\"];\n");
        for (Node node: graph.nodes) {
        ...
        builder.append("\n");
        builder.append("node[style=\"filled\", fillcolor=\"white\"];\n");
        for (Node node: graph.nodes) {
            if (node.color.equals("")) {
                String str = Integer.toString(node.value);
                builder.append(str);
                builder.append("; ");
            }
        ...
        for (Node node : graph.nodes) {
            for (Node neighbours : node.neighbors) {
                if (node.visitNeighbors.contains(neighbours)) {
                    continue;
                }
                node.visitNeighbors.add(neighbours);
                neighbours.visitNeighbors.add(node);
                builder.append(node.value);
                builder.append("--");
                builder.append(neighbours.value);
                builder.append(";\n");
            }
        }
        for (Node node : graph.nodes) {
